...
from Tool.BaseTools import BaseModel
...
class YOLOV3Model(BaseModel):
    def __init__(
            self,
            backbone: Union[nn.Module, DarkNet_53],
...
#         self.num_classes = num_classes
#         self.num_anchors = num_anchors_for_single_size
#         # be careful this is used for each size!(yolo v3 has 3 sizes)
#
#         self.backbone = get_pretrained_darknet53(pretrained_path)  # backbone
#
#         # s = 32
#         self.conv_set_3 = nn.Sequential(
#             Conv(1024, 512, k=1),
