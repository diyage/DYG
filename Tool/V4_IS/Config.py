...
class YOLOV4EvalConfigIS:
    ...
    segmentation_mask_th_for_eval: float = 0.5
    iou_th_for_eval: float = 0.5


class YOLOV4VisualizationConfigIS:

    conf_th_for_show: float = 0.0
    prob_th_for_show: float = 0.0
    score_th_for_show: float = 0.3
    segmentation_mask_th_for_show: float = 0.5
    iou_th_for_show: float = 0.5


class YOLOV4ConfigIS:
    ...
    data_config = YOLOV4DataSetConfigIS()
    train_config = YOLOV4TrainConfigIS()
    eval_config = YOLOV4EvalConfigIS()
    show_config = YOLOV4VisualizationConfigIS()
